...
#pragma HLS ARRAY_PARTITION variable=thres_FPGABipolarConvThresholdLayer_br1 complete dim=1
#pragma HLS ARRAY_PARTITION variable=thres_FPGABipolarConvThresholdLayer_br1 complete dim=3
